...
const ExpertBookings = () => {
  ...
  const expertBookings = useSelector((state) => state.booking?.expertBookings || { upcoming: [], past: [] });
  const isLoading = useSelector((state) => state.loaderState?.loaders?.[LOADER_TYPES.EXPERT_BOOKINGS]);
  ...
  useEffect(() => {
    ...
    updateConnectStates();
    intervalRef.current = setInterval(updateConnectStates, 30000);
  ...
  const handleCancel = (bookingId) => {
    if (window.confirm('Are you sure you want to cancel this booking?')) {
      dispatch(cancelBooking(bookingId, null, () => dispatch(fetchExpertBookings())));
    }
  };
          ...
          <div className="flex-grow">
            ...
            <div className="flex items-center gap-4 mb-3">
              ...
              <div className="text-sm">
                ...
                <span className="text-gray-500 dark:text-gray-400 text-xs ml-1">earned</span>
              </div>
            </div>
  ...
  const renderEmptyState = () => (
    ...
    >
      <PeopleOutlined sx={{ fontSize: 64, opacity: 0.3, marginBottom: 2 }} />
      <p className="text-lg">
  ...
  const currentBookings = Array.isArray(activeTab === 'upcoming' ? expertBookings.upcoming : expertBookings.past)
    ? (activeTab === 'upcoming' ? expertBookings.upcoming : expertBookings.past)
    : [];
      ...
      <div className="sticky top-0 z-10">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-semibold text-white flex-grow">Client Sessions</h1>
