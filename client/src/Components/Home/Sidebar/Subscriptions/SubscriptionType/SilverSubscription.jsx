...
function SilverSubscription() {
  ...
  useEffect(() => {
    ...
    const summary = `User is viewing the Silver plan page. Current plan: ${currentSub}. Silver base price: ₹${base}/day. Pricing: ${pricing}.${included ? ` Included features: ${included}.` : ""}${limits ? ` Limits: ${limits}.` : ""}${support ? ` Support: ${support}.` : ""} Custom days (7-180) available with tiered discounts.`;
    setAIPageContext({ page: "subscriptions/silver", description: summary });
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="text-center mb-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-light-secondary/10 dark:bg-dark-secondary/10 mb-2">
              <DiamondIcon sx={{ color: planColor, fontSize: 30 }} />
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-bold">Advanced Features</h3>
                    <p className="text-xs text-light-text/60">Higher limits</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
    ...
    <div>
      ...
      >
        <p className="text-sm text-light-text/60 dark:text-dark-text/60 mt-2">
          Experience advanced features and dedicated support with Silver Subscription 
        </p>
      </motion.div>
    </div>
  );
