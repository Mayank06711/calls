...
function UserSettings() {
  const settingsCards = [
    { icon: <ColorLensOutlined />, title: 'Theme', description: 'Customize your app appearance' },
    { icon: <NotificationsOutlined />, title: 'Notifications', description: 'Manage your alerts' },
    { icon: <LockOutlined />, title: 'Privacy', description: 'Control your account privacy' },
    { icon: <TuneOutlined />, title: 'Preferences', description: 'Set your app preferences' },
    { icon: <ViewQuiltOutlined />, title: 'Layout', description: 'Customize your view' },
    { icon: <AccessibilityNewOutlined />, title: 'Accessibility', description: 'Adjust accessibility options' },
    { icon: <AccessTimeOutlined />, title: 'Session Information', description: 'View active sessions' },
    { icon: <TimelineOutlined />, title: 'Usage Tracking', description: 'Monitor your activity' },
    { icon: <VideoLibraryOutlined />, title: 'Reels', description: 'Manage reel preferences' },
    { icon: <BarChartOutlined />, title: 'Analytics', description: 'View your statistics' }
  ];
