...
export const SET_PROFILE_DATA_LOADING = "SET_PROFILE_DATA_LOADING";
export const SET_DARK_MODE = "SET_DARK_MODE";
export const SHOW_SESSION_LIMIT = "SHOW_SESSION_LIMIT";
export const HIDE_SESSION_LIMIT = "HIDE_SESSION_LIMIT";